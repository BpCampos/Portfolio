      ...
      <div className="  text-6xl">
        {upButton != 'upper' && (
          <BsFillArrowUpCircleFill
            className={`hover: cursor-pointer text-slate-700 fixed right-6 bottom-20 max-sm:hidden animate-bounceUp`}
            onClick={changeUpPosition}
          />
        )}
        {downButton != 'bottom' && (
          <BsFillArrowDownCircleFill
            className="hover: cursor-pointer text-slate-700 fixed z-10 right-6 bottom-1 max-sm:hidden animate-bounceDown"
